...
export function playDmailSequence() {
    return new Promise((resolve) => {
        ...
        if (wantSound) {
            stopFxAudio = playDmailFxAudio(3600) || null;
        }
        ...
        // Prefer unmuted — D-Mail is always kicked off by a user click (gesture).
        // Fall back to muted + synth bed if the browser blocks audible autoplay.
        ...
        const tryPlay = () => {
            ...
            if (playPromise && typeof playPromise.catch === 'function') {
                playPromise.catch((err) => {
                    ...
                    // If unmuted play was blocked, mute and retry (synth bed still plays).
