...
export async function sendUserEmail({
    ...
    if (dmail) {
        ...
        if (showOutbox) {
            ...
            // Keep an in-memory outbound shape for archive / UI without polluting outbox
            outbound = {
        ...
        if (redirectSelf) {
            // Cosmetic delivery to the user’s own phone — always three split parts (e.g. 36 → 12+12+12).
            ...
            // Insert part 3 → 2 → 1 so inbox (unshift) lists 1/3, 2/3, 3/3 from the top.
