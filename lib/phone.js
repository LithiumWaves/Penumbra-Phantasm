...
function renderDmailSettings(view) {
    ...
    const rows = [
        ...
        },
        {
            ...
            on: tiers.spectacle,
            title: 'Spectacle',
            blurb: 'Play divergence meter + end distortion only — does not create worldline facts.',
        },
        {
            key: 'dmailWorldline',
            on: tiers.worldline,
        ...
        },
        {
            ...
            on: tiers.apply,
            title: 'Apply',
            blurb: 'Strong apply: system chat note + sticky note on the active character card.',
        },
    ];
    ...
    view.innerHTML = `
        ...
        <div class="pp-scroll">
            <p class="pp-settings-note">
                Mail to <strong>${escapeHtml(PHONEWAVE_NAME)}</strong> uses these tiers when the contact is visible.
            </p>
            ${rows.map((r) => `
