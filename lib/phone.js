...
export function initPhoneChrome() {
    ...
    if (!wrap) {
        ...
        wrap.innerHTML = `
            <button type="button" id="pp-mail-chip" class="pp-mail-chip" title="Open Phone Trigger" aria-label="Open mail">
            ...
            <button type="button" id="pp-fab" class="pp-fab" title="Phone Trigger" aria-label="Phone Trigger" hidden>
    ...
    } else if (!document.getElementById('pp-mail-chip')) {
        const chip = document.createElement('button');
        chip.type = 'button';
        chip.id = 'pp-mail-chip';
        chip.className = 'pp-mail-chip';
        chip.title = 'Open Phone Trigger';
...
export function updateFabVisibility() {
    ...
    const showFab = settings.enabled && settings.showFloatingButton;
