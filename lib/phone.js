...
function renderCallDial(view) {
    ...
    view.innerHTML = `
        ...
        <div class="pp-scroll pp-call-dial">
            <p class="pp-settings-note">Talk in the handset — private from the main chat.</p>
...
async function renderRead(view) {
    ...
    view.innerHTML = `
        ...
        <div class="pp-scroll pp-read">
                ...
                ${mail.isDmail ? `<div class="pp-settings-note">D-Mail${mail.dmailPart && mail.dmailPartTotal ? ` · part ${mail.dmailPart}/${mail.dmailPartTotal}` : ''}${mail.dmailRedirectName ? ` · → ${escapeHtml(mail.dmailRedirectName)}` : ''}</div>` : ''}
            </div>
...
function renderCompose(view) {
    ...
    const dmailOptionsHtml = dmailSelected
        ? `
            ...
            <p class="pp-settings-note">Cosmetic only — which handset “receives” the transmission.</p>
            <label class="pp-field">
            ...
            <p class="pp-settings-note">Cosmetic inbox timestamp when redirecting to your own phone.</p>
        `
        : '';
