/** @typedef {'home'|'mail'|'inbox'|'outbox'|'read'|'compose'|'settings'|'wallpaper'|'sounds'|'memory'|'dmail'|'dmail-propose'|'dmail-card'|'call-dial'|'call'} PhoneScreen */
...
/** Marker wrapping worldline text appended to character description on Apply. */
export const WORLDLINE_CARD_START = '⟦Phone Trigger Worldline⟧';
export const WORLDLINE_CARD_END = '⟦/Phone Trigger Worldline⟧';
/** Dedicated lorebook + always-on entry used by Apply (hard). */
...
export const DEFAULT_SETTINGS = Object.freeze({
    ...
    dmailPropose: false,
    /** Write accepted facts to lorebook + (confirmed) character card — stronger than prompt-only. */
    dmailApply: false,
