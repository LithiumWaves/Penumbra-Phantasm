/** @typedef {'home'|'mail'|'inbox'|'outbox'|'read'|'compose'|'settings'|'wallpaper'|'sounds'|'memory'|'dmail'|'dmail-propose'|'call-dial'|'call'} PhoneScreen */
...
export const DEFAULT_SETTINGS = Object.freeze({
    ...
    dmailPropose: false,
    /** Write the accepted worldline fact into chat history + character card note (stronger than prompt-only). */
    dmailApply: false,
