/** @typedef {'home'|'mail'|'inbox'|'outbox'|'read'|'compose'|'settings'|'wallpaper'|'sounds'|'memory'|'dmail'|'dmail-propose'|'handset'} PhoneScreen */
...
export const DEFAULT_SETTINGS = Object.freeze({
    ...
    dmailPropose: false,
    /** Write the accepted worldline fact into chat history (stronger than prompt-only). */
    dmailApply: false,
    /**
    ...
    /**
     * Handset shell style.
     * - keitai: red flip-phone (default Steins;Gate look)
     * - generic: neutral slab phone for plain e-mail use
     * @type {'keitai'|'generic'}
     */
    phoneDesign: 'keitai',
    /**
