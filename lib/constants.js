/** @typedef {'home'|'mail'|'inbox'|'outbox'|'read'|'compose'|'settings'|'wallpaper'|'sounds'|'memory'} PhoneScreen */
...
export const DEFAULT_SETTINGS = Object.freeze({
    enabled: true,
    /** Legacy round FAB — off by default; prefer the mail status chip. */
    showFloatingButton: false,
    /** Compact MAIL chip in the corner — primary way to open the phone. */
    showMailChip: true,
